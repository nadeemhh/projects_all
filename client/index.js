...
let ReportTemplate =`<div  style="height:29.7cm;width:21cm; margin-bottom: 15px;margin-left: auto;margin-right: auto;page-break-before: always;display: flex;flex-direction: column;justify-content: space-between; box-shadow: 5px 5px #41404054;background-color: rgb(255, 255, 255);" class='${className2} reporttemplate'>
...
<p class="p-patient-details4 mp">Ref. By</p>
...
<p class="pp-patient-details4 mp">dr.roy</p>
...
<div>
<img style="height: 100%; width: 100%;transform: translateY(-18%);" src="./ins.png" alt="">
</div>
</div>
</div>`;
...
for (let ii = leftTest.count; ii < arr.length; ii++) {
    ...
    <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Nam reiciendis quas id inventore fugiat doloremque consequatur assumenda, recusandae magni hic vitae aperiam nobis cumque similique necessitatibus adipisci iste ad possimus! ${arr[ii]}</p>
    </div>`;
